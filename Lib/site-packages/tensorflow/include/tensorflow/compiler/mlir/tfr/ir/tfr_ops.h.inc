...
public:
  ...
  ::mlir::MutableOperandRange getTensorListMutable();
...
public:
  ...
  ::mlir::MutableOperandRange getActMutable();
  ::mlir::MutableOperandRange getScaleMutable();
  ::mlir::MutableOperandRange getZpMutable();
  std::pair<unsigned, unsigned> getODSResultIndexAndLength(unsigned index);
  ::mlir::Operation::result_range getODSResults(unsigned index);
  ::mlir::Value getMin();
  ::mlir::Value getMax();
...
public:
  ...
  ::mlir::Value getInScales();
  ::mlir::MutableOperandRange getOutScaleMutable();
  ::mlir::MutableOperandRange getInScalesMutable();
  std::pair<unsigned, unsigned> getODSResultIndexAndLength(unsigned index);
  ::mlir::Operation::result_range getODSResults(unsigned index);
